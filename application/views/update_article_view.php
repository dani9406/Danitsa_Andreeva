    ...
    <body>
        ...
        <form class="form-horizontal" enctype="multipart/form-data" role="form" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="article_title" value="<?php echo $row->article_title ?>"/>
                </div>                  
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control" rows="6" name="article_content" value=""><?php echo $row->article_content ?></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="article_author" value="<?php echo $row->article_author ?>" />
                </div>
            </div>   
